...
module BasicConstructs =
    ...
    square 3  |> ignore           // Now run the function. Again, no parens.

    let add x y = x + y           // don't use add (x,y)! It means something
                                  // completely different.
    add 2 3 |> ignore             // Now run the function.
    ...
    evens oneToFive  |> ignore    // Now run the function
